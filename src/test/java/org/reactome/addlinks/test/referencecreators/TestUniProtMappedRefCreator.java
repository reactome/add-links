...
//			}
//		});
		List<GKInstance> identifiers = objectCache.getByRefDbAndSpecies(refDBID, speciesDBID, className);
		return identifiers;
	}
	...
	public void testUPRefCreatorWormbase() throws Exception
	{
		...
		upMappedWormbaseRefCreator.createIdentifiers(123456, mappings, identifiers );
	}
//	
//	@Test
